...
<figure>
  <JzImage filename="recruiting-cbre" alt="poops"/>
</figure>

<figure>
  <div className="two-up">
    <JzImage filename='recruiting-cbre' alt="A sampling of CBRE's broker-centric recruiting materials." />
    <JzImage filename='recruiting-tech' alt="A sampling of recruiting materials from tech companies." />
  </div>
...
<figure>
  <JzImage filename='bob-the-builder' alt="CBRE CEO Bob Sulentic poses for a smile at the NYC CBRE Build office, in front of a glass wall covered in our circuitmap brand graphics." />
...
<figure>
  <JzImage filename='posters0' alt="" />
  <JzImage filename='posters1' alt="" />
...
<WidthBleeder style={{marginBottom:0}}>
  ...
  <Slider classNameTray="center">
    ...
    <Slide index={1}>
      <JzImage filename='style-guide' alt="Pages from the Build brand style guide." className="shadow"/>
    </Slide>
    <Slide index={2}>
      <video loop autoplay playsinline muted width="100%">
    ...
    <Slide index={3}>
      <JzImage filename='swag' alt="Build swag, including duffel bags and enamel pins." />
    </Slide>
    <Slide index={4}>
      <JzImage filename='slides' alt="Slide templates with various Build graphics." />
    </Slide>
  </Slider>
...
<WidthBleeder style={{marginBottom:0}}>
  ...
  <Slider classNameTray="center">
    <Slide index={0}>
      <JzImage filename='office1' alt="" />
    </Slide>
    <Slide index={1}>
      <JzImage filename='signs' alt="" />
    </Slide>
    <Slide index={2}>
      <JzImage filename='office0' alt="" />
    </Slide>
  </Slider>
  <DotGroup showAsSelectedForCurrentSlideOnly={true}/>
</ScrollableCarouselProvider>
...
<figure>
  <JzImage filename='brand-new' alt="CBRE Build featured on Brand New's website." />
</figure>
...
<figure>
  <JzImage filename='brand-life' alt="" />
