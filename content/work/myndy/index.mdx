...
<figure>
      <FlexContainer breakpoint="768px">
            <JzImage filename='myndy-process-0' alt="" objectFit="contain" />
            <JzImage filename='myndy-process-1' alt="" objectFit="contain" />
      </FlexContainer>
      <FlexContainer breakpoint="768px">
            <JzImage filename='myndy-process-3' alt="" objectFit="contain" />
            <JzImage filename='myndy-process-4' alt="" objectFit="contain" />
      </FlexContainer>
...
<figure>
      <FlexContainer breakpoint="768px">
            <JzImage filename='fitness' alt="" objectFit="contain" />
            <JzImage filename='rhythm' alt="" objectFit="contain" />
      </FlexContainer>
      <FlexContainer breakpoint="768px">
            <JzImage filename='practical' alt="" objectFit="contain" />
            <JzImage filename='sunlight-0' alt="" objectFit="contain" />
      </FlexContainer>
      <FlexContainer breakpoint="768px">
            <JzImage filename='sunlight-1' alt="" objectFit="contain" style={{maxWidth:'50%', alignSelf: 'center'}}/>
      </FlexContainer>
...
<figure>
      <FlexContainer breakpoint="768px">
            <JzImage filename='confetti 1' alt="" objectFit="contain" />
      </FlexContainer>
      <FlexContainer breakpoint="768px">
            <JzImage filename='family' alt="" objectFit="contain" />
            <JzImage filename='two women' alt="" objectFit="contain" />
      </FlexContainer>
      <FlexContainer breakpoint="768px">
            <JzImage filename='headscarf' alt="" objectFit="contain" />
            <JzImage filename='bummer girl' alt="" objectFit="contain" />
      </FlexContainer>
      <FlexContainer breakpoint="768px">
            <JzImage filename='women chatting' alt="" objectFit="contain" />
      </FlexContainer>
...
<figure class="shadow">
      <FlexContainer breakpoint="768px">
            <JzImage filename='brand-color' alt="" objectFit="contain" />
            <JzImage filename='brand-logo-type' alt="" objectFit="contain" />
      </FlexContainer>
      <FlexContainer breakpoint="768px">
            <JzImage filename='brand-pyramid' alt="" objectFit="contain" />
      </FlexContainer>
